...
var (
	// TKPOWChainConfig is the chain parameters to run a node on the TKPOW network (PoW).
	TKPOWChainConfig = &coregeth.CoreGethChainConfig{
		NetworkID: TKPOWChainID.Uint64(),
		ChainID:   new(big.Int).Set(TKPOWChainID),
		...
		// No EIP-1559 / BASEFEE.
		// TKPOW keeps the legacy PoW gas fee model.
		EIP1559FBlock: nil,
		EIP3198FBlock: nil,
